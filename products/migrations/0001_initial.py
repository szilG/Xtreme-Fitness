    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('friendly_name', models.CharField(blank=True, max_length=254, null=True)), # noqa
            ],
        ),
        migrations.CreateModel(
            name='Product',
            fields=[
                ...
                ('long_description', models.TextField(blank=True, null=True)), # noqa
                ('image_2', models.ImageField(
                    blank=True, null=True, upload_to='')),
                ('category', models.ForeignKey(
                    blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='products.category')), # noqa
            ],
        ),
    ]
